...
final hizbsStatsNotifierProvider =
    NotifierProvider<HizbsStatsNotifier, List<Map<HighlightType, int>>>(
      HizbsStatsNotifier.new,
    );

class HizbsStatsNotifier extends Notifier<List<Map<HighlightType, int>>> {
  @override
